...
<body onload="setFocus()">
  <div class=" body">
    <h1>Contact Us</h1>
    <form action="contact-mail.php" name="contact" method="post">
      ...
      <div class="form-group">
        ...
        <textarea name="comment" rows="4" cols="80" class="form-control" id="comment" placeholder="Comment"></textarea>
      </div>
...
<script>
  let setFocus = () => document.getElementById("name").focus();
</script>
